...
class JibimoValidatePay extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'jibimo:validatePay';
     ...
     * @var string
     */
    protected $description = 'Validate normal pay transaction.';
    ...
    {
        $response = $jibimo->validatePay(124978, "09366061280", 2000,
            'live-test');
