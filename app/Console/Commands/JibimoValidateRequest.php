...
class JibimoValidateRequest extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'jibimo:validateRequest';
     ...
     * @var string
     */
    protected $description = 'Validate request transaction.';
    ...
    {
        $response = $jibimo->validateRequest(124979, "09366061280", 2000,
            'live-test');
